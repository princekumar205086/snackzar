...
const navItems = [
    ...
    { label: 'Assignments', href: '/delivery/assignments',        icon: 'guide' },
    { label: 'Profile',     href: '/delivery/profile',            icon: 'developer' },
];
        ...
        >
            ...
            <div class="flex-shrink-0 border-t border-[#e4e9f0]" :class="isExpanded ? 'p-4' : 'p-3'">
                ...
                <div v-if="isExpanded" class="p-3 bg-[#f8f9fc] border border-[#eef0f4] rounded-[10px] mb-4">
                    <p class="text-[12px] font-bold text-[#142033] mb-0.5">Delivery Account</p>
                    <p class="text-[11px] text-[#6a778c] leading-[1.4] mb-2.5">Manage your delivery assignments.</p>
                </div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 top-[110%] w-[180px] bg-white border border-[#e4e9f0] rounded-xl shadow-xl py-1 hidden group-focus-within:block lg:group-focus-within:hidden hover:block z-[80]">
                            <div class="px-4 py-2.5 border-b border-[#e4e9f0] mb-1">
                                <p class="text-[13px] font-semibold text-[#142033] line-clamp-1">{{ user?.name || 'Delivery Partner' }}</p>
                                <p class="text-[11px] text-[#6a778c] line-clamp-1 mt-0.5">{{ user?.email || 'delivery@example.com' }}</p>
                            </div>
