...
return [
    ...
    'title' => 'Snackzar API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'REST API for Snackzar — Bihar\'s premium Makhana & snacks ecommerce marketplace. Supports User, Seller, Delivery Partner, and Admin panels.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token by calling the <b>POST /api/v1/login</b> endpoint with your email and password. The token is returned in the response body.',
    ],
